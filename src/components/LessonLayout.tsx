...
const level1Lessons: LessonMeta[] = [
  ...
  { id: "1-6", path: "/courses/1-6", title: "Q-Learning: табличный метод", type: "lesson" },
  { id: "1-3", path: "/courses/1-3", title: "CartPole — твой первый RL-агент", type: "lesson" },
  { id: "1-4", path: "/courses/1-4", title: "DQN с нуля на PyTorch", type: "lesson" },
  { id: "1-5", path: "/courses/1-5", title: "Марковские процессы принятия решений (MDP)", type: "lesson" },
