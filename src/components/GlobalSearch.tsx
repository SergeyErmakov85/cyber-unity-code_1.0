...
const searchItems: SearchItem[] = [
  ...
  { title: "CartPole — первый агент", path: "/courses/1-4", group: "Уроки", keywords: "cartpole agent" },
  { title: "DQN с нуля на PyTorch", path: "/courses/1-5", group: "Уроки", keywords: "dqn deep q-network" },
  { title: "MDP — Марковские процессы принятия решений", path: "/courses/1-6", group: "Уроки", keywords: "mdp markov bellman" },
