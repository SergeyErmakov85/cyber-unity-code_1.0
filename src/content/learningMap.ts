...
export const LEARNING_MAP: Stage[] = [
  {
    ...
    lessons: [
      ...
      { id: "1-3", slug: "q-learning-tabular", title: "Q-Learning: табличный метод", type: "lesson", path: "/courses/1-3", contextLinks: linksFor("q-learning-tabular") },
      { id: "1-4", slug: "cartpole", title: "CartPole — твой первый RL-агент", type: "lesson", path: "/courses/1-4", contextLinks: linksFor("cartpole") },
